...
class AppKafkaPaymentConsumer(
    ...
    private val consumer: Consumer<String, String> = config.createKafkaPaymentConsumer(),
    private val producer: Producer<String, String> = config.createKafkaPaymentProducer()
) {
